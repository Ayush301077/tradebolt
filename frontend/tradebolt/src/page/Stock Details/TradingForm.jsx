...
const TradingForm = () => {
  ...
  const handleBuyCrypto = () => {
    ...
    // Fetch updated assets and recalculate total invested amount
    dispatch(getUserAssets(localStorage.getItem("jwt")));
  };
  console.log("Coin Image URL:", coin.coinDetails?.image?.large);
  ...
  return (
    <div className="space-y-10 p-5">
      ...
      <div className="">
        ...
        <Button
          variant = "link"
          className="w-full mt-5 text-xl text-white"
