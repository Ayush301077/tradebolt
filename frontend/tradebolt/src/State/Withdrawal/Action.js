...
export const withdrawalRequest = ({amount, jwt}) => async(dispatch) => {
    ...
    try{
        ...
        dispatch({
            type:WITHDRAWAL_SUCCESS, payload: response.data,
        });
    }
    catch(error){
        console.log(error);
...
export const proceedWithdrawal = ({id, jwt, accept}) => async(dispatch) => {
    ...
    try{
        ...
        console.log("withdrawal proceed -------",response.data);

        dispatch({
            type:WITHDRAWAL_PROCEED_SUCCESS, payload: response.data,
        });
    }
    catch(error){
        console.log(error);
...
export const getAllWithdrawalRequest = jwt => async(dispatch) => {
    ...
    try{
        ...
        dispatch({
            type:GET_WITHDRAWAL_REQUEST_SUCCESS, payload: response.data,
        });
    }
    catch(error){
        console.log(error);
...
export const addPaymentDetails = ({paymentDetails,jwt}) => async(dispatch) => {
    ...
    try{
        ...
        dispatch({
            type:ADD_PAYMENT_DETAILS_SUCCESS, payload: response.data,
        });
    }
    catch(error){
        console.log(error);
...
export const getPaymentDetails = ({jwt}) => async(dispatch) => {
    ...
    try{
        ...
        dispatch({
            type:GET_PAYMENT_DETAILS_SUCCESS, payload: response.data,
        });
    }
    catch(error){
        console.log(error);
