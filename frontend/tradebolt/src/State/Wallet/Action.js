...
export const getUserWallet = (jwt) => async(dispatch) => {
    ...
    try{
        ...
        dispatch({
            type:types.GET_USER_WALLET_SUCCESS, payload: response.data,
        });
...
export const depositMoney = ({jwt, orderId, paymentId, navigate}) => async(dispatch) => {
    ...
    try{
        ...
        dispatch({
            type:types.DEPOSIT_MONEY_SUCCESS, payload: response.data,
        });
        navigate("/wallet")
...
export const paymentHandler = ({jwt, amount, paymentMethod}) => async(dispatch) => {
    ...
    try{
        ...
        // dispatch({
        //     type:types.DEPOSIT_MONEY_SUCCESS, psyload: response.data,
        // });
    }
    catch(error){
        console.log(error);
...
//         dispatch({
//             type:types.TRANSFER_MONEY_SUCCESS, payload: response.data,
//         });
//     }
//     catch(error){
//         console.log(error);
